...
승격하고, `Telemetry Matrix`에서 Memory, Disk Health, Battery Power,
Network Events, Reconnect History, Thermal Throttling, Kernel Warnings,
Agent Freshness를 함께 보여줍니다. 이후 fan과 더 깊은 SMART/NVMe health도
같은 matrix 구조로 확장합니다.
...
- Memory, Disk Health, Battery Power, Network Events, Reconnect History, Thermal Throttling, Kernel Warnings, Agent Freshness를 묶는 Telemetry Matrix
...
- kernel thermal, storage, power warning 요약과 NetworkManager reconnect 요약
