...
승격하고, `Telemetry Matrix`에서 Memory, Network Events, Reconnect History,
Thermal Throttling, Kernel Warnings, Agent Freshness를 함께 보여줍니다. 이후
battery, fan, disk health를 같은 matrix 구조로 확장합니다.
...
- Memory, Network Events, Reconnect History, Thermal Throttling, Kernel Warnings, Agent Freshness를 묶는 Telemetry Matrix
