...
승격하고, `Telemetry Matrix`에서 Memory, Network Events, Kernel Warnings,
Agent Freshness를 함께 보여줍니다. 이후 battery, fan, disk health, reconnect
history, thermal throttling event를 같은 matrix 구조로 확장합니다.
...
- Memory, Network Events, Kernel Warnings, Agent Freshness를 묶는 Telemetry Matrix
