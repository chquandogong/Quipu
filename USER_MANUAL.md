...
`Get-StorageReliabilityCounter`, Event Log, LibreHardwareMonitor/OpenHardwareMonitor
WMI sensor로 노출하는 범위에서 다음 metric/event를 best-effort로 보냅니다.
...
Fan RPM, Telemetry Matrix에 바로 표시됩니다.
