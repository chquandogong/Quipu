...
`Telemetry Matrix` 同时展示 Memory、Disk Health、Battery Power、
Network Events、Reconnect History、Thermal Throttling、Kernel Warnings
和 Agent Freshness。fan 与更深入的 SMART/NVMe health 之后也可以沿用同一
matrix 结构扩展。
...
- 展示 Memory、Disk Health、Battery Power、Network Events、Reconnect History、Thermal Throttling、Kernel Warnings、Agent Freshness 的 Telemetry Matrix
