...
`Telemetry Matrix` 同时展示 Memory、Network Events、Kernel Warnings 和
Agent Freshness。Battery、fan、disk health、reconnect history 和 thermal
throttling event 之后也可以沿用同一 matrix 结构扩展。
...
- 展示 Memory、Network Events、Kernel Warnings、Agent Freshness 的 Telemetry Matrix
