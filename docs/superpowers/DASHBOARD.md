...
> Status: v0.14.8 released — Apache-2.0 licensed, documentation and repository presentation current
> Date: 2026-07-16
> Owner: chquan
...
| Done     | Device status transition UI and left workspace tabs | v0.14.5: horizontal status transitions, Smart Advisor/Actions tabs, demo seeding removed, `dev-server.sh` binds `0.0.0.0`                      |
| Done     | Documentation rework                                | v0.14.6: all three READMEs, user manual, CONTRIBUTING, and SECURITY rewritten against the current implementation; manual seeding documented    |
| Done     | Apache-2.0 license adoption                         | v0.14.7: LICENSE/NOTICE, SPDX metadata in pyproject/package.json, dynamic README badges, dashboard screenshot, repo description/topics         |
| Done     | License visibility in product UI                    | v0.14.8: `Project info` chip shows `License: Apache-2.0`; README license sections in all three editions                                        |
| Done     | Retroactive releases                                | GitHub releases exist for every tag from v0.14.3 through v0.14.8                                                                               |
...
The v0.14.8 release shipped after local test/build/browser verification and CI success.
