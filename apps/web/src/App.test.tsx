  ...
  devices: [
    {
      ...
      latest_metrics: {
        ...
        "nvme.nvme0n1.capacity_bytes": {
          value: 512110190592,
          unit: "bytes",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "nvme.read_bytes_per_sec": {
          value: 12582912,
          unit: "bytes_per_sec",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "nvme.write_bytes_per_sec": {
          value: 4194304,
          unit: "bytes_per_sec",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "nvme.nvme0n1.read_bytes_per_sec": {
          value: 12582912,
          unit: "bytes_per_sec",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "nvme.nvme0n1.write_bytes_per_sec": {
          value: 4194304,
          unit: "bytes_per_sec",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        ...
        "wifi.wlp0s20f3.signal_dbm": {
          value: -43.0,
          unit: "dbm",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "wifi.wlan0.signal_dbm": {
          value: -61.0,
          unit: "dbm",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "wifi.rx_bitrate_mbps": {
          value: 866.7,
          unit: "mbps",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "wifi.tx_bitrate_mbps": {
          value: 144.4,
          unit: "mbps",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "wifi.wlp0s20f3.rx_bitrate_mbps": {
          value: 866.7,
          unit: "mbps",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "wifi.wlp0s20f3.tx_bitrate_mbps": {
          value: 144.4,
          unit: "mbps",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "wifi.wlan0.rx_bitrate_mbps": {
          value: 72.2,
          unit: "mbps",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "wifi.wlan0.tx_bitrate_mbps": {
          value: 58.5,
          unit: "mbps",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
      ...
      recent_events: [
        {
          ...
          message_summary:
            "Wi-Fi reconnect observed within the incident window.",
    ...
    },
    {
      ...
      latest_metrics: {
        ...
        "cpu.p_core_1.load_percent": {
          value: 41.5,
          unit: "percent",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "cpu.e_core_2.load_percent": {
          value: 18,
          unit: "percent",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        ...
        "wifi.wifi0.signal_dbm": {
          value: -52.5,
          unit: "dbm",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "wifi.wifi0.rx_bitrate_mbps": {
          value: 1201,
          unit: "mbps",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "wifi.wifi0.tx_bitrate_mbps": {
          value: 1201,
          unit: "mbps",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "wifi.wi_fi.link_bitrate_mbps": {
          value: 961,
          unit: "mbps",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "thermal.windows_zone_tz_tz00.temp_c": {
          value: 32.05,
          unit: "celsius",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        ...
        "nvme.hfs256gej9x101n.capacity_bytes": {
          value: 256060514304,
          unit: "bytes",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "nvme.samsung_ssd_980_pro_1tb.capacity_bytes": {
          value: 1000204886016,
          unit: "bytes",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        ...
        "nvme.hfs256gej9x101n.temp_c": {
          value: 55,
          unit: "celsius",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "nvme.hfs256gej9x101n_composite_temperature.temp_c": {
          value: 55,
          unit: "celsius",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "nvme.hfs256gej9x101n_critical_temperature.temp_c": {
          value: 86,
          unit: "celsius",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "nvme.hfs256gej9x101n_temperature_1.temp_c": {
          value: 44,
          unit: "celsius",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "nvme.hfs256gej9x101n_temperature_2.temp_c": {
          value: 53,
          unit: "celsius",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "nvme.hfs256gej9x101n_warning_temperature.temp_c": {
          value: 85,
          unit: "celsius",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "nvme.samsung_ssd_980_pro_1tb.temp_c": {
          value: 45,
          unit: "celsius",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "nvme.samsung_ssd_980_pro_1tb_composite_temperature.temp_c": {
          value: 45,
          unit: "celsius",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "nvme.samsung_ssd_980_pro_1tb_critical_temperature.temp_c": {
          value: 84,
          unit: "celsius",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "nvme.samsung_ssd_980_pro_1tb_warning_temperature.temp_c": {
          value: 81,
          unit: "celsius",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        ...
        "nvme.hfs256gej9x101n.read_bytes_per_sec": {
          value: 0,
          unit: "bytes_per_sec",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "nvme.hfs256gej9x101n.write_bytes_per_sec": {
          value: 0,
          unit: "bytes_per_sec",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "nvme.samsung_ssd_980_pro_1tb.read_bytes_per_sec": {
          value: 0,
          unit: "bytes_per_sec",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
        "nvme.samsung_ssd_980_pro_1tb.write_bytes_per_sec": {
          value: 0,
          unit: "bytes_per_sec",
          observed_at: "2026-07-07T03:00:00+00:00",
        },
      ...
      recent_events: [
        {
          ...
          message_summary:
            "C:\\Windows\\System32\\WUDFHost.exe ���μ��� ID:4164",
  ...
  items: [
    {
      ...
      evidence: "Latest CPU package temperature is 86.4C.",
      next_step:
        "Inspect thermal evidence and compare cooling or workload windows.",
  ...
  timeline: [
    {
      ...
      source: "kernel",
      summary:
        "CPU0: Core temperature above threshold, cpu clock throttled during compile workload.",
  ...
  hypotheses: [
    {
      ...
      contradicting_evidence: [
        "No before/after intervention window has been recorded yet.",
      ],
      missing_checks: [
        "Inspect thermal evidence and compare cooling or workload windows.",
      ],
  ...
  actions: [
    {
      ...
      description:
        "Record physical cooling changes and compare load-adjusted temperatures.",
    },
  ],
  interventions: [
    {
      ...
      expected_effect:
        "Temperature should drop in the next observation window.",
      recorded_at: "2026-07-07T03:05:00+00:00",
      verification_status: "pending",
      verification_result: {
        status: "helped",
        summary:
          "CPU package temperature fell by 17.4C after Raised rear edge.",
        window_minutes: 30,
        checks: [
          {
...
describe("App", () => {
  it("renders the investigation workflow as the primary surface", async () => {
    ...
    const fetchMock = vi.fn(
      async (input: RequestInfo | URL, init?: RequestInit) => {
        ...
        if (
          url.endsWith("/api/investigations/xps-13%3Athermal/notes") &&
          init?.method === "POST"
        ) {
          return {
            ok: true,
        ...
        if (
          url.endsWith("/api/investigations/xps-13%3Athermal/interventions") &&
          init?.method === "POST"
        ) {
    ...
    await waitFor(() =>
      expect(
        screen.getByRole("region", { name: "Devices" }),
      ).toBeInTheDocument(),
    );
    expect(container.querySelector(".page-command-dark")).toBeInTheDocument();
    expect(
      screen.getByRole("region", { name: "Investigation command center" }),
    ).toBeInTheDocument();
    ...
    expect(
      screen.getByRole("region", { name: "Problem guide" }),
    ).toBeInTheDocument();
    ...
    await waitFor(() =>
      expect(
        screen.getByRole("region", { name: "Telemetry Brief" }),
      ).toBeInTheDocument(),
    );
    ...
    expect(
      screen.getByRole("region", { name: "Workflow rail" }),
    ).toBeInTheDocument();
    ...
    const stageList = within(workflowRail).getByRole("list", {
      name: "DTIHAVR stages",
    });
    ...
    expect(
      screen.getByRole("region", { name: "Fleet Brief" }),
    ).toBeInTheDocument();
    const fleetBrief = screen.getByRole("region", { name: "Fleet Brief" });
    expect(screen.getByText("Fleet Brief")).toBeInTheDocument();
    expect(
      within(fleetBrief).getByLabelText("Total devices: 2"),
    ).toBeInTheDocument();
    expect(
      within(fleetBrief).getByLabelText("Critical devices: 0"),
    ).toBeInTheDocument();
    expect(
      within(fleetBrief).getByLabelText("Warning devices: 1"),
    ).toBeInTheDocument();
    expect(
      within(fleetBrief).getByLabelText("Open issues: 1"),
    ).toBeInTheDocument();
    expect(
      within(fleetBrief).getByText(
        "Total은 현재 fleet에서 관측된 장비 수입니다.",
      ),
    ).toBeInTheDocument();
    expect(
      within(fleetBrief).getByText(
    ...
    expect(
      screen.getByText("Build laptop · build-xps / thermal"),
    ).toBeInTheDocument();
    const fleetDevices = screen.getByRole("region", { name: "Devices" });
    expect(
      within(fleetDevices).getByText("Build laptop · build-xps"),
    ).toBeInTheDocument();
    expect(
      within(fleetDevices).getByText("윈도우 · DOGU_CHQUAN"),
    ).toBeInTheDocument();
    expect(
      within(fleetDevices).getByText(/\d+ metrics \/ 2 events/),
    ).toBeInTheDocument();
    ...
    expect(
      screen.queryByText("Creator and visual references"),
    ).not.toBeInTheDocument();
    expect(
      screen.queryByText("Dogu Robotics · Dogu X · Physical AI"),
    ).not.toBeInTheDocument();
    ...
    expect(
      screen.getAllByText("Build laptop · build-xps").length,
    ).toBeGreaterThan(0);
    ...
    expect(
      within(selectedCaseStatus).getByText("Medium").closest(".status-chip"),
    ).toHaveClass("priority-medium");
    expect(
      screen.getByText(
    ...
    expect(
      within(selectedCaseStatus)
        .getByText("Warning · thermal")
        .closest(".status-chip"),
    ).toHaveClass("risk-warning");
    expect(
      screen.getByText(
    ...
    expect(
      screen.getByText(
        "선택된 warning 출처: Build laptop · build-xps / thermal - CPU package temperature is elevated.",
      ),
    ).toBeInTheDocument();
    expect(screen.getByText("Workflow stage / 진행 단계")).toBeInTheDocument();
    expect(
      screen.getAllByText(
        "Triage는 감지된 근거를 분류하고 다음 조사 항목을 고르는 단계입니다.",
      ).length,
    ).toBeGreaterThan(0);
    expect(
      screen.getByRole("region", { name: "Operations Rail" }),
    ).toBeInTheDocument();
    ...
    await waitFor(() =>
      expect(
        screen.getByRole("button", {
          name: "Explain CPU package temperature metric",
        }),
      ).toBeInTheDocument(),
    );
    expect(
      screen.getByText(
        "정의: 선택한 장비의 CPU 패키지 센서 온도입니다. (CPU package temperature)",
      ),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("button", {
        name: "Explain Linux load average windows metric",
      }),
    ).toBeInTheDocument();
    expect(
      screen.getByText(
        "정의: 최근 1/5/15분 동안 실행 중이거나 대기 중인 작업 평균입니다. (Linux load average)",
      ),
    ).toBeInTheDocument();
    expect(
      screen.getByText(
        "해석: CPU 코어 수와 온도 추세를 함께 봐야 과부하인지 판단할 수 있습니다.",
      ),
    ).toBeInTheDocument();
    expect(
      screen.queryByText("Cores: core 0 84.0C · core 1 82.5C"),
    ).not.toBeInTheDocument();
    ...
    expect(
      screen.queryByLabelText("CPU core 2 temperature: -"),
    ).not.toBeInTheDocument();
    expect(cpuCore3).toHaveTextContent("3");
    expect(cpuCore3).toHaveTextContent("81.5C");
    expect(
      screen.queryByText("Windows: 1m 3.70 · 5m 2.10 · 15m 0.90"),
    ).not.toBeInTheDocument();
    expect(screen.getByLabelText("Load average 1m: 3.70")).toHaveClass(
      "breakdown-nominal",
    );
    expect(screen.getByLabelText("Load average 5m: 2.10")).toHaveClass(
      "breakdown-nominal",
    );
    expect(screen.getByLabelText("Load average 15m: 0.90")).toHaveClass(
      "breakdown-nominal",
    );
    expect(
      screen.queryByText("Devices: nvme0 42.9C · nvme1 44.2C"),
    ).not.toBeInTheDocument();
    expect(
      screen.getByLabelText(
        "NVMe nvme0n1: 42.9C · 477 GB · R 12 MB/s · W 4 MB/s",
      ),
    ).toHaveClass("breakdown-nominal");
    expect(screen.getByLabelText("NVMe nvme1: 44.2C")).toHaveClass(
      "breakdown-nominal",
    );
    expect(
      screen.queryByText("Interfaces: wlp0s20f3 -43 dBm · wlan0 -61 dBm"),
    ).not.toBeInTheDocument();
    expect(
      screen.getByLabelText(
        "Wi-Fi wlp0s20f3: -43 dBm · Rx 867 Mbps · Tx 144 Mbps",
      ),
    ).toHaveClass("breakdown-nominal");
    expect(
      screen.getByLabelText(
        "Wi-Fi wlan0: -61 dBm · Rx 72.2 Mbps · Tx 58.5 Mbps",
      ),
    ).toHaveClass("breakdown-nominal");
    expect(
      screen.getByRole("button", {
        name: "Explain Wi-Fi signal strength metric",
      }),
    ).toBeInTheDocument();
    expect(
      screen.getByText(
        "정의: 무선 연결의 수신 신호 강도입니다. (Wi-Fi signal strength, dBm)",
      ),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("region", { name: "Telemetry coverage matrix" }),
    ).toBeInTheDocument();
    const telemetryMatrix = screen.getByRole("region", {
      name: "Telemetry coverage matrix",
    });
    expect(
      within(telemetryMatrix).getByText("15/15 observed"),
    ).toBeInTheDocument();
    expect(
      within(telemetryMatrix).getByText(
        "관측된 범주 수입니다. 위험 점수가 아니라, 조사에 필요한 자료가 얼마나 들어왔는지 보여줍니다.",
      ),
    ).toBeInTheDocument();
    expect(
      within(telemetryMatrix).getByText("Missing: none"),
    ).toBeInTheDocument();
    ...
    expect(screen.getAllByText("14 cores / 18 threads").length).toBeGreaterThan(
      0,
    );
    expect(
      screen.getByText("Intel Core Ultra 5 125H. Topology: P 4, E 8, LP-E 2."),
    ).toBeInTheDocument();
    expect(screen.getAllByText("Wi-Fi Link").length).toBeGreaterThan(0);
    expect(
      screen.getAllByText("Rx 867 Mbps / Tx 144 Mbps").length,
    ).toBeGreaterThan(0);
    ...
    expect(
      screen.getAllByText(
        "Raised the rear edge and will compare the next two batches.",
      ).length,
    ).toBeGreaterThan(0);
    ...
    expect(
      screen.getByRole("button", { name: "Record action" }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("button", { name: "Verify result" }),
    ).toBeInTheDocument();
    await waitFor(() =>
      expect(screen.getAllByText("-17.4C").length).toBeGreaterThan(0),
    );
    expect(screen.getAllByText("Report").length).toBeGreaterThan(0);
    await waitFor(() =>
      expect(
        screen.getAllByText("Check cooling and workload").length,
      ).toBeGreaterThan(0),
    );

    fireEvent.change(screen.getByLabelText("Intervention label"), {
      target: { value: "Raised rear edge" },
    });
    fireEvent.change(screen.getByLabelText("Intervention description"), {
      target: {
        value: "Lifted one side of the laptop to improve bottom airflow.",
      },
    });
    fireEvent.click(
      screen.getByRole("button", { name: "Record intervention" }),
    );

    await waitFor(() =>
      expect(screen.getAllByText("Raised rear edge").length).toBeGreaterThan(0),
    );
    const postCall = fetchMock.mock.calls.find(
      ([input, init]) =>
        String(input).includes("/interventions") && init?.method === "POST",
    );
    expect(postCall).toBeDefined();
    expect(JSON.parse(String(postCall?.[1]?.body)).label).toBe(
      "Raised rear edge",
    );
    ...
    await waitFor(() =>
      expect(
        screen.getByText("Thermal result handed off to the next operator."),
      ).toBeInTheDocument(),
    );
    const notePostCall = fetchMock.mock.calls.find(
      ([input, init]) =>
        String(input).includes("/notes") && init?.method === "POST",
    );
    expect(notePostCall).toBeDefined();
    expect(JSON.parse(String(notePostCall?.[1]?.body)).body).toBe(
      "Thermal result handed off to the next operator.",
    );

    const windowsDeviceButton = within(fleetDevices)
      .getByText("윈도우 · DOGU_CHQUAN")
      .closest("button");
    ...
    await waitFor(() =>
      expect(
        screen.getByRole("heading", { name: "Device telemetry overview" }),
      ).toBeInTheDocument(),
    );
    expect(
      screen.getByText("No active investigations for this device."),
    ).toBeInTheDocument();
    expect(screen.getByText("Healthy · device")).toBeInTheDocument();
    expect(
      screen.getAllByText(
        "윈도우 · DOGU_CHQUAN is visible in Devices and currently has no active issue.",
      ).length,
    ).toBeGreaterThan(0);
    expect(screen.getAllByText("12 cores / 16 threads").length).toBeGreaterThan(
      0,
    );
    expect(
      screen.getByText("13th Gen Intel Core i5-1340P. Topology: P 4, E 8."),
    ).toBeInTheDocument();
    ...
    expect(
      screen.getByRole("button", {
        name: "Explain Windows thermal zone temperature metric",
      }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("button", {
        name: "Explain Windows CPU core temperatures metric",
      }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("button", {
        name: "Explain Windows CPU core load metric",
      }),
    ).toBeInTheDocument();
    expect(
      screen.getByLabelText("CPU P core 1 temperature: 58.0C"),
    ).toHaveClass("breakdown-nominal");
    expect(
      screen.getByLabelText("CPU E core 2 temperature: 49.0C"),
    ).toHaveClass("breakdown-nominal");
    expect(screen.getByLabelText("CPU P core 1 load: 41.5%")).toHaveClass(
      "breakdown-nominal",
    );
    expect(screen.getByLabelText("CPU E core 2 load: 18.0%")).toHaveClass(
      "breakdown-nominal",
    );
    ...
    expect(
      screen.getByLabelText(
        "NVMe hfs256gej9x101n: 55.0C · 238 GB · R 0 B/s · W 0 B/s",
      ),
    ).toHaveClass("breakdown-nominal");
    expect(
      screen.getByLabelText(
        "NVMe samsung_ssd_980_pro_1tb: 45.0C · 932 GB · R 0 B/s · W 0 B/s",
      ),
    ).toHaveClass("breakdown-nominal");
    expect(
      screen.queryByText("hfs256gej9x101n_composite_temperature"),
    ).not.toBeInTheDocument();
    expect(
      screen.queryByText("hfs256gej9x101n_critical_temperature"),
    ).not.toBeInTheDocument();
    expect(
      screen.queryByText("samsung_ssd_980_pro_1tb_warning_temperature"),
    ).not.toBeInTheDocument();
    expect(
      screen.getByText("Power policy scheme was reset by WUDFHost.exe."),
    ).toBeInTheDocument();
    expect(
      screen.getAllByText(
  ...
  it("groups Intel Core Ultra 5 125H core sensors by core type", async () => {
    ...
    await waitFor(() =>
      expect(
        screen.getByLabelText(
          "P core group: 8 50.8C, 12 51.2C, 16 51.6C, 20 52.0C",
        ),
      ).toBeInTheDocument(),
    );
    expect(
      screen.getByLabelText(
        "E core group: 0 50.0C, 1 50.1C, 2 50.2C, 3 50.3C, 4 50.4C, 5 50.5C, 6 50.6C, 7 50.7C",
      ),
    ).toBeInTheDocument();
    expect(
      screen.getByLabelText("LP-E core group: 32 53.2C, 33 53.3C"),
    ).toBeInTheDocument();
    expect(
      screen.getByLabelText("CPU P core 8 temperature: 50.8C"),
    ).toHaveTextContent("8");
    expect(
      screen.getByLabelText("CPU E core 0 temperature: 50.0C"),
    ).toHaveTextContent("0");
    expect(
      screen.getByLabelText("CPU LP-E core 32 temperature: 53.2C"),
  ...
  it("shows an explicit CPU core sensor absence state", async () => {
    ...
    await waitFor(() =>
      expect(
        screen.getByLabelText(
          "CPU core temperatures: no per-core sensors reported",
        ),
      ).toBeInTheDocument(),
    );
    expect(screen.getByText("No core sensors")).toBeInTheDocument();
    expect(
      screen.queryByLabelText("CPU core 0 temperature: 84.0C"),
    ).not.toBeInTheDocument();
  });
});
